...
Расчет множества Мандельброта происходит по следующей формуле:
$
x_{n+1} = x_n^2 - y_n^2+x_0$;
$y_{n+1} = 2x_ny_n+y_0
$,
где $(x_{n+1}, y_{n+1})$ - координаты текущей рассчитываемой точки, $(x_{n}, y_{n})$ - координаты предыдущей рассчитанной точки. Когда расстояние от текущей точки до точки $(0, 0)$ превышает заранее заданный радиус (в моем случае 10), рассчет для конкретной точки множества $(x_0, y_0)$ останавливается. Цвет точки множества с координатами $(x_0, y_0)$ зависит от количества рассчитанных точек n (до остановки расчетов), которые "не вышли за радиус".
В моем случае была выбрана цветовая гамма $(n \cdot 35, \text{ } 100 - 2 \cdot n, \text{ } n \cdot 7)$ для 3-х компонент rgb каждой точки $(x_0, y_0)$.
В окне SFML реализована визуализация множества Мандельброта. 
Реализована возможность изменения параметров рисунка путем нажатия следующих клавиш:
